...
### Added
- Added `spicyweb\contenttemplates\console\controllers\PcController`
...
### Changed
- When applying a content template to a new entry draft, a slug is no longer generated for the draft
